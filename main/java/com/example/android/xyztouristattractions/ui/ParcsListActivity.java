 ...
 */
public class ParcsListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, new ParcsListFragment())
                    .commit();
        }
...
*/
    ...
    public void caricaItinComp(int id) {
        Intent intent = new Intent(this, DiarioActivity.class);
        startActivity(intent);
    }
    public void caricaSetting(int id) {
        Intent intent = new Intent(this, DiarioActivity.class);
        startActivity(intent);
    }
    public void caricaShare(int id) {
        Intent intent = new Intent(this, DiarioActivity.class);
        startActivity(intent);
    }
    public void caricaSend(int id) {
        Intent intent = new Intent(this, DiarioActivity.class);
        startActivity(intent);
    }*/
